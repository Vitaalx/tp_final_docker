...
<div
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <h1 style="color: white">Serveur 1</h1>
        @auth
            <h2 style="color: white;"><em>Utilisateurs :</em></h2>
            <table>
                <tr>
                    <th>ID</th>
                    <th>Nom</th>
        ...
        @else
            <h3 style="color: white;">Vous n'êtes pas connecté !</h3>
        @endauth
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        Serveur 1 - Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
                    </div>
                </div>
    </div>
</div>
